...
function FloatingVideo({ source, height, width, author, thumbnail, className }: Props) {
  ...
  return (
      <div className={classes.root}>
          <div className={classes.floating}>
            <VideoPlayer source={source} height={height} width={width} thumbnail={thumbnail} />
          </div>
        {author && (
            <div className={classes.bottomBox}>
                <div className={classes.quoteContainer}>
                    ...
                    <div className={classes.row}>
                        ...
                        <Icon name="TTC_Logo_Icon" className={classes.logo} style={{ height: '39px', width: '127px' }} />
                    </div>
                </div>
            </div>
        )}
