...
function DetailsCard({ title, subtitle, onRegister, onBook, onIndividual, onCompany, individual, company, individualDetails, companyDetails, className }: Props) {
    ...
    const [companyType, setCompanyType] = React.useState({id: 0, title: 'Type of Company'});
    const [role, setRole] = React.useState({id: 0, title: 'What role best describes you'});
    ...
    React.useEffect(() => {
        ...
        if (companyDetails) {
            companyDetails = {
                ...
                companyEmail,
                number,
                companyType: companyType.title !== 'Type of Company' ? companyType.title : "",
  ...
  return (
      <div className={classNames(classes.root, className)}>
          ...
          <div className={classNames(classes.subtitle, classes.center)}>{subtitle}</div>
          {(!individual && !company) && (
          ...
          {(individual || company) && (
            <form className={classes.form}>
                ...
                {company && <Dropdown
                    ...
                    setSelected={(selected: DropdownOption) => setCompanyType(selected)}
          ...
          <div
            ...
            onClick={onBook}
          >
              Or <span className={classes.blueText}>Book A Demo</span> today for more information
        </div>
      </div>
  );
}
