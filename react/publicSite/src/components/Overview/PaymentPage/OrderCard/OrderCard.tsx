  ...
  return (
    <div className={classNames(classes.root, className)}>
      ...
      <div className={classNames(classes.row, classes.border)}>
        <div
          className={classNames(classes.tableHeader, classes.left)}
          style={{ flex: 3 }}
        >
          PRODUCT
        </div>
        <div className={classes.tableHeader} style={{ flex: 1 }}>
          QUANTITY
        </div>
        <div className={classes.tableHeader} style={{ flex: 1 }}>
          PRICE
      ...
      {orderItems &&
        orderItems.map((item: OrderItem) => (
          <div
            className={classNames(classes.row, classes.padding)}
            key={item.id}
          >
            ...
            <div className={classes.detail} style={{ flex: 1 }}>
              {item.quantity}
            </div>
            <div className={classes.detail} style={{ flex: 1 }}>
              £{item.price}
