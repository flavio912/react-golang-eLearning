      ...
      >
          <div className={classes.row}>
            <div className={classes.column} >
                <div className={classes.title}>Redefining <span className={classes.blueText}>the future</span> of compliance training</div>
                <div className={classes.description}>Offering a full range of dangerous goods training and consultancy led by an expert team recognised in the UK and internationally</div>
