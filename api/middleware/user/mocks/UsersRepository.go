...
// CompanyActivity provides a mock function with given fields: companyUUID, page
func (_m *UsersRepository) CompanyActivity(companyUUID gentypes.UUID, page *gentypes.Page) ([]models.CourseTakerActivity, gentypes.PageInfo, error) {
	ret := _m.Called(companyUUID, page)

	var r0 []models.CourseTakerActivity
	if rf, ok := ret.Get(0).(func(gentypes.UUID, *gentypes.Page) []models.CourseTakerActivity); ok {
		r0 = rf(companyUUID, page)
	} else {
		if ret.Get(0) != nil {
...
// UsersFromTakers provides a mock function with given fields: uuids
func (_m *UsersRepository) UsersFromTakers(uuids []gentypes.UUID) (*[]models.Delegate, *[]models.Individual) {
	ret := _m.Called(uuids)
