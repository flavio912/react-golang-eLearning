...
func TestTakerActivity(t *testing.T) {
	...
	t.Run("Gets a takers activity", func(t *testing.T) {
		activityItems, err := usersRepo.TakerActivity(gentypes.MustParseToUUID("f6d7978d-5e1a-45e9-ae8d-fad5d9c10539"))
		assert.Nil(t, err)
...
func TestTakerActivitys(t *testing.T) {
	...
	t.Run("Gets multiple takers activityItems", func(t *testing.T) {
		activityItems, err := usersRepo.TakerActivitys([]gentypes.UUID{
